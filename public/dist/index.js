...
})({"ybsCb":[function(require,module,exports) {
...
},{"./login":"7yHem","./mapbox.js":"3zDlz","./updateSettings":"l3cGY","./stripe":"10tSC"}],"7yHem":[function(require,module,exports) {
...
const login = async function(email, password) {
    try {
        ...
        if (res.data.status === "success") {
            (0, _alerts.showAlert)(res.data.status, "Logged in succesfully");
            window.setTimeout(()=>{
                location.assign("/");
            }, 1500);
        }
...
},{"@babel/polyfill":"dTCHC","axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dTCHC":[function(require,module,exports) {
"use strict";
require("./noConflict");
...
const displayMap = (locations)=>{
    mapboxgl.accessToken = "pk.eyJ1IjoiMTR0aGFuZzYiLCJhIjoiY2xhYmtwcHd4MDFhMDQwbWl3bnplNmJ0byJ9.5_m4rl03xNWvG6wLKtazcQ";
    const map = new mapboxgl.Map({
        container: "map",
        style: "mapbox://styles/14thang6/clacdxdud000414mp3ce2fekt",
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alerts = require("./alerts");
const updateUser = async function(data, type) {
    try {
        const res = await (0, _axiosDefault.default)({
            method: "patch",
        ...
        if (res.data.status === "success") {
            (0, _alerts.showAlert)(res.data.status, "Updated succesfully");
            window.setTimeout(()=>{
                location.reload();
            }, 1500);
        }
...
},{"@babel/polyfill":"dTCHC","axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"10tSC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alerts = require("./alerts");
/*eslint-disable*/ const stripe = Stripe("pk_test_51MDnFVInuCLRAOs3PLLd8lB6jaF9BEgotCHj5RoWnlmx67kOISjoMoCl824SWFddBpUxJVceI7p8dkNw8WqqX8t7001Y8j5kdO");
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./alerts":"6Mcnf"}]},["ybsCb","f2QDv"], "f2QDv", "parcelRequire11c7")
